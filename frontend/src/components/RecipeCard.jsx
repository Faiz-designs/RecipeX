            ...
            <button
              ...
              className={`flex items-center justify-center gap-1.5 text-xs font-semibold rounded-xl px-2 py-2.5 border transition-all duration-200 active:scale-[0.97] ${
                isFav
                  ...
                  : 'bg-slate-50 dark:bg-slate-700/50 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-600 hover:border-red-200 dark:hover:border-red-700/50 hover:shadow-sm'
              }`}
            >
