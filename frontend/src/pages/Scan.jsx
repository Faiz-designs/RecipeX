...
export default function Scan() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      {showReport && r && (
        <div className="animate-fadeIn">
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-100 dark:border-slate-700 p-4 md:p-6 mb-8">
            ...
            <div id="section-veg" className="mb-8 scroll-mt-20">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                {r.scan_summary.items.map((item) => (
                  <div key={item.id} className="group bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 p-4 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
