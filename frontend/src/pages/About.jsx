...
const techStack = [
  ...
  { name: 'FastAPI', color: 'text-red-600 dark:text-red-400' },
  { name: 'Groq AI', color: 'text-orange-600 dark:text-orange-400' },
  { name: 'SQLite', color: 'text-blue-600 dark:text-blue-400' },
  { name: 'PythonAnywhere', color: 'text-rose-600 dark:text-rose-400' },
    ...
    <>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-red-600 via-red-500 to-rose-600 py-20 md:py-28">
        ...
        <div className="relative max-w-3xl mx-auto text-center px-4">
          ...
          <p className="text-lg text-red-100/90 mb-6 leading-relaxed max-w-xl mx-auto">
      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-16">
          {features.map((item, i) => (
            <div key={i} className="group glass-card rounded-2xl shadow-sm p-6 hover:shadow-xl hover:border-red-300 dark:hover:border-red-600 hover:-translate-y-1 transition-all duration-300">
              <div className="w-12 h-12 bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-900/50 dark:to-rose-900/50 rounded-xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm">
                {item.emoji}
              </div>
