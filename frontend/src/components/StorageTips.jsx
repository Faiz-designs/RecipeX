  ...
  return (
    <div className="mb-8">
      <div className="flex items-center gap-2 mb-4">
        <div className="w-8 h-8 bg-gradient-to-br from-red-500 to-rose-600 rounded-lg flex items-center justify-center text-sm shadow-sm">❄️</div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {storage_tips.map((veg) => (
          <div key={veg.vegetable_id} className="glass-card rounded-2xl shadow-sm overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
            <div className="bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/30 dark:to-rose-900/30 px-4 py-3 border-b border-stone-100 dark:border-stone-700">
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300">⏱ {veg.shelf_life_days} {t('storage.days')}</span>
                {veg.refrigerate
