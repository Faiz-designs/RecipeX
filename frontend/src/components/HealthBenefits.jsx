  ...
  return (
    <div className="mb-8">
      <div className="flex items-center gap-2 mb-4">
        <div className="w-8 h-8 bg-gradient-to-br from-orange-500 to-amber-600 rounded-lg flex items-center justify-center text-sm shadow-sm">💚</div>
          ...
          <div key={veg.vegetable_id} className="glass-card rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="p-4 grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {veg.benefits?.map((b, i) => (
                <div key={i} className="bg-orange-50/50 dark:bg-orange-900/15 border border-emerald-100 dark:border-orange-800/40 rounded-xl p-3.5 hover:shadow-sm transition-shadow">
                  <div className="flex items-center gap-1.5 mb-1">
                    <span className="w-2 h-2 rounded-full bg-orange-500 shrink-0" />
                    <h4 className="font-bold text-orange-700 dark:text-orange-300 text-sm">{b.benefit}</h4>
                  </div>
